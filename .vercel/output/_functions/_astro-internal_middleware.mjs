...
import "./chunks/astro-designed-error-pages_CQ0J3LOo.mjs";
import "piccolore";
import "./chunks/astro/server_DIDqcQmM.mjs";
import "clsx";
import { s as sequence } from "./chunks/index_DYWTQGaM.mjs";
async function createAsyncLocalStorage() {
  const { AsyncLocalStorage } = await import("async_hooks");
  return new AsyncLocalStorage();
}
var authAsyncStorage = await createAsyncLocalStorage();
const __vite_import_meta_env__ = { "ASSETS_PREFIX": void 0, "BASE_URL": "/", "DEV": false, "MODE": "production", "PROD": true, "PUBLIC_CLERK_PUBLISHABLE_KEY": "pk_test_ZmxleGlibGUtd2FydGhvZy00MS5jbGVyay5hY2NvdW50cy5kZXYk", "PUBLIC_CONVEX_URL": "https://kindly-beagle-851.convex.cloud", "SITE": void 0, "SSR": true };
function getContextEnvVar(envVarName, contextOrLocals) {
  ...
  return Object.assign(__vite_import_meta_env__, { CLERK_SECRET_KEY: "sk_test_LxiGvlePq9jcldKnqO6uasiMqeeqBKdplYGiac3N2k", _: process.env._ })[envVarName];
}
...
var createClerkClientWithOptions = (context, options) => createClerkClient({
  ...
  userAgent: `${"@clerk/astro"}@${"2.16.17"}`,
  sdkMetadata: {
    name: "@clerk/astro",
    version: "2.16.17",
    // eslint-disable-next-line turbo/no-undeclared-env-vars
    environment: Object.assign(__vite_import_meta_env__, { CLERK_SECRET_KEY: "sk_test_LxiGvlePq9jcldKnqO6uasiMqeeqBKdplYGiac3N2k", _: process.env._ }).MODE
  },
  telemetry: {
